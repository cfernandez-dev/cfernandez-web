...
const TRANSLATIONS = {
    'es': {
        ...
        '0_exp_location': 'Remoto (Bogotá, Colombia)',
        '0_exp_title': 'Líder de Inteligencia Artificial',
        '0_exp_company': 'Subocol S.A.',
        '0_exp_period': 'Noviembre 2025 - Presente',
        '0_exp_desc_1': '• Liderazgo y gestión del equipo de inteligencia artificial.',
        '0_exp_desc_2': '• Estrategia y visión para la implementación de soluciones de IA a escala empresarial.',
        '0_exp_desc_3': '• Diseñar, desarrollar y desplegar modelos avanzados de AI/ML/LLM en entornos productivos.',
        '0_exp_desc_4': '• Trabajar de manera colaborativa con stakeholders para identificar, priorizar y materializar oportunidades de alto impacto mediante IA.',
        '0_exp_desc_5': '• Gestionar proyectos de MLOps y diseñar arquitecturas de IA en la nube, principalmente sobre AWS.',
        '1_exp_location': 'Remoto (Bogotá, Colombia)',
        '1_exp_title': 'Especialista en Inteligencia Artificial',
        '1_exp_company': 'Subocol S.A.',
        '1_exp_period': 'Enero 2022 - Noviembre 2025',
        ...
        '3_exp_title': 'Investigador',
        '3_exp_company': 'Universidad del Valle',
        '3_exp_period': 'Febrero 2019 - Enero 2023',
        '3_exp_desc_1': '• Diseño e implementación de un modelo computacional para el pronóstico de series de tiempo usando datos satelitales.',
        '3_exp_desc_2': '• Implementación de técnicas de Deep learning para el pronóstico de series de tiempo.',
        '3_exp_desc_3': '• Implementación de técnicas de Machine learning para clustering en datos de precipitaciones.',
        '3_exp_desc_4': '• Manejo de servicios en AWS.',
        '4_exp_title': 'Monitor Asistente de Investigación',
        '4_exp_company': 'Universidad del Valle',
        '4_exp_period': 'Febrero 2016 - Marzo 2017',
        '4_exp_desc_1': '• Implementación de algoritmos de visión artificial.',
        '4_exp_desc_2': '• Desarrollo de rutinas para los movimientos del robot móvil humanoide NAO, utilizando Python.',
        '4_exp_desc_3': '• Trabajo con cámaras stereo para imitación de movimientos humanos.',
        '4_exp_desc_4': '• Colaboración en proyectos de investigación en robótica y visión artificial.',
    ...
    'en': {
        ...
        '0_exp_location': 'Remote (Bogotá, Colombia)',
        '0_exp_title': 'Artificial Intelligence Leader',
        '0_exp_company': 'Subocol S.A.',
        '0_exp_period': 'November 2025 - Present',
        '0_exp_desc_1': '• Leadership and management of the Artificial Intelligence team.',
        '0_exp_desc_2': '• Strategy and vision for implementing enterprise-scale AI solutions.',
        '0_exp_desc_3': '• Design, develop and deploy advanced AI/ML/LLM models in production environments.',
        '0_exp_desc_4': '• Work collaboratively with stakeholders to identify, prioritize and materialize high-impact opportunities through AI.',
        '0_exp_desc_5': '• Manage MLOps projects and design cloud-based AI architectures, primarily on AWS.',
        '1_exp_location': 'Remote (Bogotá, Colombia)',
        '1_exp_title': 'Artificial Intelligence Specialist',
        '1_exp_company': 'Subocol S.A.',
        '1_exp_period': 'January 2022 - November 2025',
